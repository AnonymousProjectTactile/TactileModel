...
import sys 
sys.path.append('/home/xinbei/桌面/project1_TactileModel/Version1/Module3/CPD_pytorch1/')
...
def main():
    ...
    fish_target = np.loadtxt(path + 'data/fish_target.txt')
    ...
    fish_source = np.loadtxt(path + 'data/fish_source.txt')
